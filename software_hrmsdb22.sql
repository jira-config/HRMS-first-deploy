...
(2, 'PHP Software Store', 'Pisoli, Pune, India', 'softwarestore.biz@gmail.com', '8271897347', 'assets/img/icons/2022-02-08/log.png', 'assets/img/icons/2017-04-03/m.png', 'english', 'Asia/Kolkata', 'LTR', '© 2022. All rights reserved.');
...
(1, 'Mrinal', 'Kumar', '', 'softwarestore.biz@gmail.com', 'a15040958f7d593e18c13eb36de1adf3', NULL, '', '2022-02-08 20:54:36', '2022-02-08 20:57:19', '157.41.139.19', 1, 1);
...
--
ALTER TABLE `attendance_history`
  MODIFY `atten_his_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `sec_role_permission`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1434;
